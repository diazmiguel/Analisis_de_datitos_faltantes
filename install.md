# Datitos Faltantes guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `datitos_faltantes/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `datitos_faltantes` folder and use the modules inside your notebooks :
...
```python
from datitos_faltantes.utils.paths import data_dir
data_dir()
```
